...
function ContactLinks() {
  ...
  return (
    <div className="fixed bottom-[5rem] right-5 flex flex-col items-end gap-4 z-50 bg-white p-4 rounded-md shadow-md">
    <div className="mb-2">
      <a href={whatsappLink} target="_blank" rel="noopener noreferrer">
        <Whatsapp size="54" color="#25d366" variant="Bold" />
      </a>
    </div>
    <div className="mb-2">
      <div>
